...
def main(argv):
   ...
   group3.add_argument('--xc', '--xcompensate',  metavar='mm', type=float, default=0, help='Offset all X movements by this when switching directions (movement/backlash compensation).')
   group3.add_argument('--yc', '--ycompensate', metavar='mm', type=float,  default=0,  help='Offset all Y movements by this when switching directions (movement/backlash compensation).')
   group3.add_argument('--zc', '--zcompensate', metavar='mm', type=float,  default=0,  help='Offset all Z movements by this when switching directions (movement/backlash compensation).')

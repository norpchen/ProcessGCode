...
def main(argv):
   ...
   parser.add_argument('--split', metavar=('second filename', 'layer, zheight, nthlayer, or path','value'),nargs=3,  default='', help='Split the file into a second file based on layer, height or path type.')
   parser.add_argument('--inject', metavar=('injected filename', 'layer, zheight, nthlayer, or path','value'),nargs=3,  default='', help='Insert the file snippet based on layer, height or path type.')
